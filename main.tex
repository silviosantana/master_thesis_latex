...
\usepackage{capt-of}
\usepackage[labelfont=it,width=0.9\linewidth]{caption}
\usepackage{listings}
...
angle=0,
contents={%
  \includegraphics[width=\paperwidth,height=\paperheight]{images/eit_deck_1.pdf}
  }%
}
...
\normalsize  
 ...
 \vspace{2cm} 
  ...
  \textit{Sílvio Heverton Campelo de Santana}\\ 
...
\MS{\begin{tabular}[t]{l@{\hspace{1cm}}l}
  Betreuer: 
  & Betreuer1\SSSAY{who to include here?}, \\
  & Betreuer2\SSSAY{who to include here?} \\ 
\end{tabular}}
...
\Stud{\begin{tabular}[t]{l@{\hspace{1cm}}l}
  Betreuer: 
  & Betreuer1, \\ \TLSAY{Me and Prof. Kunz}
  & Betreuer2 \\ 
\end{tabular}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{2cm}
Kaiserslautern, September of 2020}\SSSAY{Is only the month enough or also the day?}
\TLSAY{Both. Just  put today in it's fine} 
}
...
\newpage
\input{chapters/3_Pipelined_Processors}
\newpage
\input{chapters/4_algorithm}
\newpage
\input{chapters/5_ri5cy}
\newpage
